        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribersEmails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_ClaimRequests_AcceptedClaimRequestClaimRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Companies_CurrentCompanyCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusChangeRequests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_StatusChangeRequests_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_Companies_PageCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Replies_Reviews_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClaimRequests_CompanyId",
                table: "ClaimRequests",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ClaimRequests_SubmitterId",
                table: "ClaimRequests",
                column: "SubmitterId");

            migrationBuilder.CreateIndex(
                name: "IX_Companies_AcceptedClaimRequestClaimRequestId",
                table: "Companies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusChangeRequests_CompanyId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClaimRequests_AspNetUsers_SubmitterId",
                table: "ClaimRequests",
                column: "SubmitterId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClaimRequests_Companies_CompanyId",
                table: "ClaimRequests",
                column: "CompanyId",
                principalTable: "Companies",
                principalColumn: "CompanyId",
